...
(function() {
  var ApiError, Gmail, IMessage, IMessagePart, IQueryToTasklist, ITask, ITaskList, ITaskLists, ITasks, IThread, IThreads, Promise, States, Sync, TaskListSync, async, asyncmachine, auth, coroutine, events, google, promisify, type, _ref,
  ...
  Sync = (function(_super) {
    ...
    Sync.prototype.active_requests = null;

    Sync.prototype.executed_requests = null;
