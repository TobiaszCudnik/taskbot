System.register("../../../../../node_modules/chai-interface/node_modules/tracery/is", [], function() {
  "use strict";
  var __moduleName = "../../../../../node_modules/chai-interface/node_modules/tracery/is";
  ...
  var builtins = ['Date', 'RegExp', 'DataView', 'ArrayBuffer', 'Float32Array', 'Float64Array', 'Int8Array', 'Int16Array', 'Int32Array', 'Uint8Array', 'Uint16Array', 'Uint32Array'];
  ...
  function is(predicate) {
    ...
    if (predicate instanceof RegExp)
      return is.RegExMatch(predicate);
    if (is.Function(predicate))
      return predicate;
    if (is.Null(predicate))
      return K(false);
    if (Array.isArray(predicate))
      return all(is(predicate[0]));
...
System.get("../../../../../node_modules/chai-interface/node_modules/tracery/is" + '');
