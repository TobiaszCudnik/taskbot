...
declare module 'winston' {
  ...
  namespace winston {
    ...
    export interface Winston {
      ...
      add(
        transport: winston.TransportInstance,
        options?: winston.TransportOptions,
        created?: boolean
      ): winston.LoggerInstance
      clear(): void
      remove(
        transport: string | winston.TransportInstance
      ): winston.LoggerInstance
    ...
    export type NPMLoggingLevel =
      ...
      | 'debug'
      | 'silly'
    export type SyslogLoggingLevel =
      | 'emerg'
      | 'alert'
      | 'crit'
      | 'error'
    ...
    export interface DailyRotateFileTransportInstance
    ...
    export interface HttpTransportOptions
      extends GenericTransportOptions,
        GenericNetworkTransportOptions {
      ssl?: boolean
    }
    ...
    export interface WinstonModuleTransportOptions
      extends GenericTransportOptions {
      [optionName: string]: any
    }
