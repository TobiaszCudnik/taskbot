...
interface ErrorConstructor {
   ...
   * ```
   */
  captureStackTrace<T extends { stack?: string }>(
    targetObject: T,
    constructorOpt?: new () => T
  ): void
...
declare module 'querystring' {
  ...
  export function parse<T extends { [key: string]: string | string[] }>(
    str: string,
    sep?: string,
    eq?: string,
    options?: ParseOptions
...
declare module 'cluster' {
  ...
  export function on(
    event: 'listening',
    listener: (worker: Worker, address: any) => void
  ): void
  export function on(
    event: 'message',
    listener: (worker: Worker, message: any) => void
  ): void
...
declare module 'repl' {
  ...
  export class REPLServer extends Interface {
    ...
    defineCommand(
      keyword: string,
      cmd: REPLCommand | { help: string; action: REPLCommand }
    ): void
...
declare module 'vm' {
  ...
  export function runInContext(
    code: string,
    contextifiedSandbox: Context,
    options?: string | RunInNewContextOptions
  ): any
...
declare module 'child_process' {
  ...
  export class ChildProcess extends events.EventEmitter
    implements events.Listener<'close', (code: number, signal: string) => void>,
  ...
  export function spawnSync(
    command: string,
    options?: SpawnSyncOptions & { encoding: 'buffer' }
...
declare module 'fs' {
  ...
  export class FSWatcher extends events.EventEmitter
    implements events.Listener<'change', WatchListener> {
    close(): void
  }

  export class ReadStream extends stream.Readable
    implements events.Listener<'open', (fd: number) => void>,
  ...
  export function appendFile(
    file: string | Buffer | number,
    data: string | Buffer,
    options: buffer.Encoding | AppendFileOptions | null,
    callback: (err: NodeJS.ErrnoException | null) => void
  ): void
  ...
  export function mkdtemp(
    prefix: string,
    callback: (err: NodeJS.ErrnoException | null, dir: string) => void
  ): void
  export function mkdtemp(
    prefix: string,
    options: buffer.Encoding | MkdtempOptions | null,
    callback: (err: NodeJS.ErrnoException | null, dir: string) => void
  ): void
  ...
  export function readdir(
    path: string | Buffer,
    options: 'buffer' | (ReadFileOptions & { encoding: 'buffer' }),
    callback: (err: NodeJS.ErrnoException | null, files: Buffer[]) => void
  ): void
  export function readdir(
    path: string | Buffer,
    options: buffer.Encoding | ReaddirOptions | null,
    callback: (err: NodeJS.ErrnoException | null, files: string[]) => void
  ): void
  ...
  export function readdirSync(
    path: string | Buffer,
    options: 'buffer' | (ReaddirOptions & { encoding: 'buffer' })
  ): Buffer[]
  export function readdirSync(
    path: string | Buffer,
    options: buffer.Encoding | ReaddirOptions | null
  ...
  export function readFile(
    ...
    options:
      | buffer.Encoding
      | (ReadFileOptions & { encoding: buffer.Encoding }),
    callback: (err: NodeJS.ErrnoException | null, data: string) => void
  ): void
  export function readFile(
    file: string | Buffer | number,
    options: 'buffer' | ReadFileOptions | null,
    callback: (err: NodeJS.ErrnoException | null, data: Buffer) => void
  ): void
  ...
  export function readFileSync(
    file: string | Buffer | number,
    options: buffer.Encoding | (ReadFileOptions & { encoding: buffer.Encoding })
  ): string
  export function readFileSync(
    file: string | Buffer | number,
    options: 'buffer' | ReadFileOptions | null
  ...
  export function readlink(
    path: string | Buffer,
    options: 'buffer' | (ReadlinkOptions & { encoding: 'buffer' }),
    callback: (err: NodeJS.ErrnoException | null, linkString: Buffer) => void
  ): void
  export function readlink(
    path: string | Buffer,
    options: buffer.Encoding | ReadlinkOptions | null,
    callback: (err: NodeJS.ErrnoException | null, linkString: Buffer) => void
  ): void
  ...
  export function realpath(
    path: string | Buffer,
    options: 'buffer' | (RealpathOptions & { encoding: 'buffer' }),
    callback: (err: NodeJS.ErrnoException | null, resolvedPath: Buffer) => void
  ): void
  export function realpath(
    path: string | Buffer,
    options: buffer.Encoding | RealpathOptions | null,
    callback: (err: NodeJS.ErrnoException | null, resolvedPath: Buffer) => void
  ): void
  ...
  export function watch(
    filename: string | Buffer,
    options: buffer.Encoding | WatchOptions | null
  ): FSWatcher
  export function watch(
    filename: string | Buffer,
    listener: WatchListener
  ...
  export function writeFile(
    file: string | Buffer | number,
    data: string | Buffer,
    options: buffer.Encoding | WriteFileOptions | null,
    callback: (err: NodeJS.ErrnoException | null) => void
  ): void
...
declare module 'tls' {
  ...
  export interface SecureContextOptions {
    ...
    key?:
      ...
      | string[]
      | Buffer
      | Array<{ pem: string | string[] | Buffer; passphrase: string }>
    /**
     * A string containing the passphrase for the private key or pfx.
     */
    passphrase?: string
...
declare module 'util' {
  ...
  export function isPrimitive(
    object: any
  ): object is string | number | boolean | null | undefined
