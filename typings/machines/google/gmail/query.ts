...
export interface IEmit extends IEmitBase {
  (event: 'FetchingThreads_enter' /*, param1: any?, param2: any? */):
    | boolean
    | void
  (event: 'FetchingThreads_state' /*, param1: any?, param2: any? */):
    | boolean
    | void
}
...
export interface ITransitions {
  ...
  FetchingThreads_state /* param1: any?, param2: any? */?():
    | boolean
    | void
    | Promise<boolean | void>
}
...
export interface IEmit extends IEmitBase {
  (event: 'ThreadsFetched_enter' /*, param1: any?, param2: any? */):
    | boolean
    | void
  (event: 'ThreadsFetched_state' /*, param1: any?, param2: any? */):
    | boolean
    | void
}
...
export interface ITransitions {
  ...
  ThreadsFetched_state /* param1: any?, param2: any? */?():
    | boolean
    | void
    | Promise<boolean | void>
}
...
export interface IEmit extends IEmitBase {
  (event: 'FetchingMsgs_enter' /*, param1: any?, param2: any? */):
    | boolean
    | void
  (event: 'FetchingMsgs_state' /*, param1: any?, param2: any? */):
    | boolean
    | void
}
...
export interface ITransitions {
  ...
  FetchingMsgs_state /* param1: any?, param2: any? */?():
    | boolean
    | void
    | Promise<boolean | void>
}
...
export interface ITransitions {
  ...
  MsgsFetched_state /* param1: any?, param2: any? */?():
    | boolean
    | void
    | Promise<boolean | void>
}
