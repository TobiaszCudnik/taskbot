...
/** machine.bind('FetchingTaskLists', (param1, param2) => {}) */
export interface IBind extends IBindBase {
  (event: 'FetchingTaskLists_enter', listener: (/* param1: any?, param2: any? */) => boolean | undefined, context?: Object): this;
  (event: 'FetchingTaskLists_state', listener: (/* param1: any?, param2: any? */) => any, context?: Object): this;
}

/** machine.emit('FetchingTaskLists', param1, param2) */
export interface IEmit extends IEmitBase {
  (event: 'FetchingTaskLists_enter' /*, param1: any?, param2: any? */): boolean | void;
  (event: 'FetchingTaskLists_state' /*, param1: any?, param2: any? */): boolean | void;
}

/** Method declarations */
export interface ITransitions {
  FetchingTaskLists_enter?(/* param1: any?, param2: any? */): boolean | void;
  FetchingTaskLists_state?(/* param1: any?, param2: any? */): boolean | void | Promise<boolean | void>;
}

// ----- ----- ----- ----- -----
// STATE: TaskListsFetched
// ----- ----- ----- ----- -----

/** machine.bind('TaskListsFetched', (param1, param2) => {}) */
export interface IBind extends IBindBase {
  (event: 'TaskListsFetched_enter', listener: (/* param1: any?, param2: any? */) => boolean | undefined, context?: Object): this;
  (event: 'TaskListsFetched_state', listener: (/* param1: any?, param2: any? */) => any, context?: Object): this;
}

/** machine.emit('TaskListsFetched', param1, param2) */
export interface IEmit extends IEmitBase {
  (event: 'TaskListsFetched_enter' /*, param1: any?, param2: any? */): boolean | void;
  (event: 'TaskListsFetched_state' /*, param1: any?, param2: any? */): boolean | void;
}

/** Method declarations */
export interface ITransitions {
  TaskListsFetched_enter?(/* param1: any?, param2: any? */): boolean | void;
  TaskListsFetched_state?(/* param1: any?, param2: any? */): boolean | void | Promise<boolean | void>;
}
...
export interface ITransitions {
  ...
  SyncDone_FetchingTaskLists?(): boolean | void;
  SyncDone_TaskListsFetched?(): boolean | void;
  ...
  Cached_FetchingTaskLists?(): boolean | void;
  Cached_TaskListsFetched?(): boolean | void;
  ...
  Restarting_FetchingTaskLists?(): boolean | void;
  Restarting_TaskListsFetched?(): boolean | void;
  ...
  Restarted_FetchingTaskLists?(): boolean | void;
  Restarted_TaskListsFetched?(): boolean | void;
  ...
  MaxReadsExceeded_FetchingTaskLists?(): boolean | void;
  MaxReadsExceeded_TaskListsFetched?(): boolean | void;
  ...
  MaxWritesExceeded_FetchingTaskLists?(): boolean | void;
  MaxWritesExceeded_TaskListsFetched?(): boolean | void;
  ...
  FetchingTaskLists_ConfigSet?(): boolean | void;
  FetchingTaskLists_SubsInited?(): boolean | void;
  FetchingTaskLists_SubsReady?(): boolean | void;
  FetchingTaskLists_Reading?(): boolean | void;
  FetchingTaskLists_ReadingDone?(): boolean | void;
  FetchingTaskLists_Syncing?(): boolean | void;
  FetchingTaskLists_SyncDone?(): boolean | void;
  FetchingTaskLists_Cached?(): boolean | void;
  FetchingTaskLists_Dirty?(): boolean | void;
  FetchingTaskLists_QuotaExceeded?(): boolean | void;
  FetchingTaskLists_Restarting?(): boolean | void;
  FetchingTaskLists_Restarted?(): boolean | void;
  FetchingTaskLists_MaxReadsExceeded?(): boolean | void;
  FetchingTaskLists_Writing?(): boolean | void;
  FetchingTaskLists_WritingDone?(): boolean | void;
  FetchingTaskLists_MaxWritesExceeded?(): boolean | void;
  ...
  FetchingTaskLists_end?(): boolean | void | Promise<boolean | void>;
  TaskListsFetched_Enabled?(): boolean | void;
  TaskListsFetched_Initializing?(): boolean | void;
  TaskListsFetched_Ready?(): boolean | void;
  TaskListsFetched_ConfigSet?(): boolean | void;
  TaskListsFetched_SubsInited?(): boolean | void;
  TaskListsFetched_SubsReady?(): boolean | void;
  TaskListsFetched_Reading?(): boolean | void;
  TaskListsFetched_ReadingDone?(): boolean | void;
  TaskListsFetched_Syncing?(): boolean | void;
  TaskListsFetched_SyncDone?(): boolean | void;
  TaskListsFetched_Cached?(): boolean | void;
  TaskListsFetched_Dirty?(): boolean | void;
  TaskListsFetched_QuotaExceeded?(): boolean | void;
  TaskListsFetched_Restarting?(): boolean | void;
  TaskListsFetched_Restarted?(): boolean | void;
  TaskListsFetched_MaxReadsExceeded?(): boolean | void;
  TaskListsFetched_Writing?(): boolean | void;
  TaskListsFetched_WritingDone?(): boolean | void;
  TaskListsFetched_MaxWritesExceeded?(): boolean | void;
  ...
  TaskListsFetched_end?(): boolean | void | Promise<boolean | void>;
...
export type TTransitions = 'Enabled_Any'
  ...
  | 'SyncDone_FetchingTaskLists'
  | 'SyncDone_TaskListsFetched'
  | 'SyncDone_Exception'
  | 'SyncDone_exit'
  | 'SyncDone_end'
  | 'Cached_Enabled'
  ...
  | 'Cached_FetchingTaskLists'
  | 'Cached_TaskListsFetched'
  | 'Cached_Exception'
  | 'Cached_exit'
  | 'Cached_end'
  | 'Dirty_Enabled'
  ...
  | 'Restarting_FetchingTaskLists'
  | 'Restarting_TaskListsFetched'
  ...
  | 'Restarted_FetchingTaskLists'
  | 'Restarted_TaskListsFetched'
  | 'Restarted_Exception'
  | 'Restarted_exit'
  | 'Restarted_end'
  ...
  | 'MaxReadsExceeded_FetchingTaskLists'
  | 'MaxReadsExceeded_TaskListsFetched'
  ...
  | 'MaxWritesExceeded_FetchingTaskLists'
  | 'MaxWritesExceeded_TaskListsFetched'
  ...
  | 'FetchingTaskLists_ConfigSet'
  | 'FetchingTaskLists_SubsInited'
  | 'FetchingTaskLists_SubsReady'
  | 'FetchingTaskLists_Reading'
  | 'FetchingTaskLists_ReadingDone'
  | 'FetchingTaskLists_Syncing'
  | 'FetchingTaskLists_SyncDone'
  | 'FetchingTaskLists_Cached'
  | 'FetchingTaskLists_Dirty'
  | 'FetchingTaskLists_QuotaExceeded'
  | 'FetchingTaskLists_Restarting'
  | 'FetchingTaskLists_Restarted'
  | 'FetchingTaskLists_MaxReadsExceeded'
  | 'FetchingTaskLists_Writing'
  | 'FetchingTaskLists_WritingDone'
  | 'FetchingTaskLists_MaxWritesExceeded'
  ...
  | 'TaskListsFetched_Initializing'
  | 'TaskListsFetched_Ready'
  | 'TaskListsFetched_ConfigSet'
  | 'TaskListsFetched_SubsInited'
  | 'TaskListsFetched_SubsReady'
  | 'TaskListsFetched_Reading'
  | 'TaskListsFetched_ReadingDone'
  | 'TaskListsFetched_Syncing'
  | 'TaskListsFetched_SyncDone'
  | 'TaskListsFetched_Cached'
  | 'TaskListsFetched_Dirty'
  | 'TaskListsFetched_QuotaExceeded'
  | 'TaskListsFetched_Restarting'
  | 'TaskListsFetched_Restarted'
  | 'TaskListsFetched_MaxReadsExceeded'
  | 'TaskListsFetched_Writing'
  | 'TaskListsFetched_WritingDone'
  | 'TaskListsFetched_MaxWritesExceeded'
