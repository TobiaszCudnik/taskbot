...
export interface IEmit extends IEmitBase {
  (event: 'FetchingTaskLists_enter' /*, param1: any?, param2: any? */):
    | boolean
    | void
  (event: 'FetchingTaskLists_state' /*, param1: any?, param2: any? */):
    | boolean
    | void
}
...
export interface ITransitions {
  ...
  FetchingTaskLists_state /* param1: any?, param2: any? */?():
    | boolean
    | void
    | Promise<boolean | void>
}
...
export interface IEmit extends IEmitBase {
  (event: 'TaskListsFetched_enter' /*, param1: any?, param2: any? */):
    | boolean
    | void
  (event: 'TaskListsFetched_state' /*, param1: any?, param2: any? */):
    | boolean
    | void
}
...
export interface ITransitions {
  ...
  TaskListsFetched_state /* param1: any?, param2: any? */?():
    | boolean
    | void
    | Promise<boolean | void>
}
