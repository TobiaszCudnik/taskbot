...
export interface IEmit extends IEmitBase {
  (event: 'FetchingTaskLists_enter'): boolean | void
  (event: 'FetchingTaskLists_state'): boolean | void
}
/** Method declarations */
export interface ITransitions {
  FetchingTaskLists_enter?(): boolean | void
  FetchingTaskLists_state?(): boolean | void | Promise<boolean | void>
}
...
export interface IBind extends IBindBase {
  ...
  (event: 'TaskListsFetched_state', listener: () => any, context?: Object): this
}
/** machine.emit('TaskListsFetched', param1, param2) */
export interface IEmit extends IEmitBase {
  (event: 'TaskListsFetched_enter'): boolean | void
  (event: 'TaskListsFetched_state'): boolean | void
}
/** Method declarations */
export interface ITransitions {
  TaskListsFetched_enter?(): boolean | void
  TaskListsFetched_state?(): boolean | void | Promise<boolean | void>
}
