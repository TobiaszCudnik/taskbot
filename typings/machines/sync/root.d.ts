...
export interface IBind extends IBindBase {
  ...
  (event: 'DBReady_state', listener: () => any, context?: Object): this
}
/** machine.emit('DBReady', param1, param2) */
export interface IEmit extends IEmitBase {
  (event: 'DBReady_enter'): boolean | void
  (event: 'DBReady_state'): boolean | void
}
/** Method declarations */
export interface ITransitions {
  DBReady_enter?(): boolean | void
  DBReady_state?(): boolean | void | Promise<boolean | void>
}
