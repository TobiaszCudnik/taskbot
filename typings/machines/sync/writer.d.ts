...
export interface IBind extends IBindBase {
    (event: 'MaxWritesExceeded_enter', listener: () => boolean | undefined, context?: Object): this;
    (event: 'MaxWritesExceeded_state', listener: () => any, context?: Object): this;
}
/** machine.emit('MaxWritesExceeded', param1, param2) */
export interface IEmit extends IEmitBase {
    (event: 'MaxWritesExceeded_enter'): boolean | void;
    (event: 'MaxWritesExceeded_state'): boolean | void;
}
/** Method declarations */
export interface ITransitions {
    MaxWritesExceeded_enter?(): boolean | void;
    MaxWritesExceeded_state?(): boolean | void | Promise<boolean | void>;
}
...
/** All the state names */
export declare type TStates = 'Enabled' | 'Initializing' | 'Ready' | 'ConfigSet' | 'SubsInited' | 'SubsReady' | 'Reading' | 'ReadingDone' | 'Syncing' | 'SyncDone' | 'Cached' | 'Dirty' | 'QuotaExceeded' | 'Restarting' | 'Restarted' | 'MaxReadsExceeded' | 'Writing' | 'WritingDone' | 'MaxWritesExceeded';
/** All the transition names */
export declare type TTransitions = 'Enabled_Any' | 'Enabled_Initializing' | 'Enabled_Ready' | 'Enabled_ConfigSet' | 'Enabled_SubsInited' | 'Enabled_SubsReady' | 'Enabled_Reading' | 'Enabled_ReadingDone' | 'Enabled_Syncing' | 'Enabled_SyncDone' | 'Enabled_Cached' | 'Enabled_Dirty' | 'Enabled_QuotaExceeded' | 'Enabled_Restarting' | 'Enabled_Restarted' | 'Enabled_MaxReadsExceeded' | 'Enabled_Writing' | 'Enabled_WritingDone' | 'Enabled_MaxWritesExceeded' | 'Enabled_Exception' | 'Enabled_exit' | 'Enabled_end' | 'Initializing_Enabled' | 'Initializing_Any' | 'Initializing_Ready' | 'Initializing_ConfigSet' | 'Initializing_SubsInited' | 'Initializing_SubsReady' | 'Initializing_Reading' | 'Initializing_ReadingDone' | 'Initializing_Syncing' | 'Initializing_SyncDone' | 'Initializing_Cached' | 'Initializing_Dirty' | 'Initializing_QuotaExceeded' | 'Initializing_Restarting' | 'Initializing_Restarted' | 'Initializing_MaxReadsExceeded' | 'Initializing_Writing' | 'Initializing_WritingDone' | 'Initializing_MaxWritesExceeded' | 'Initializing_Exception' | 'Initializing_exit' | 'Initializing_end' | 'Ready_Enabled' | 'Ready_Initializing' | 'Ready_Any' | 'Ready_ConfigSet' | 'Ready_SubsInited' | 'Ready_SubsReady' | 'Ready_Reading' | 'Ready_ReadingDone' | 'Ready_Syncing' | 'Ready_SyncDone' | 'Ready_Cached' | 'Ready_Dirty' | 'Ready_QuotaExceeded' | 'Ready_Restarting' | 'Ready_Restarted' | 'Ready_MaxReadsExceeded' | 'Ready_Writing' | 'Ready_WritingDone' | 'Ready_MaxWritesExceeded' | 'Ready_Exception' | 'Ready_exit' | 'Ready_end' | 'ConfigSet_Enabled' | 'ConfigSet_Initializing' | 'ConfigSet_Ready' | 'ConfigSet_Any' | 'ConfigSet_SubsInited' | 'ConfigSet_SubsReady' | 'ConfigSet_Reading' | 'ConfigSet_ReadingDone' | 'ConfigSet_Syncing' | 'ConfigSet_SyncDone' | 'ConfigSet_Cached' | 'ConfigSet_Dirty' | 'ConfigSet_QuotaExceeded' | 'ConfigSet_Restarting' | 'ConfigSet_Restarted' | 'ConfigSet_MaxReadsExceeded' | 'ConfigSet_Writing' | 'ConfigSet_WritingDone' | 'ConfigSet_MaxWritesExceeded' | 'ConfigSet_Exception' | 'ConfigSet_exit' | 'ConfigSet_end' | 'SubsInited_Enabled' | 'SubsInited_Initializing' | 'SubsInited_Ready' | 'SubsInited_ConfigSet' | 'SubsInited_Any' | 'SubsInited_SubsReady' | 'SubsInited_Reading' | 'SubsInited_ReadingDone' | 'SubsInited_Syncing' | 'SubsInited_SyncDone' | 'SubsInited_Cached' | 'SubsInited_Dirty' | 'SubsInited_QuotaExceeded' | 'SubsInited_Restarting' | 'SubsInited_Restarted' | 'SubsInited_MaxReadsExceeded' | 'SubsInited_Writing' | 'SubsInited_WritingDone' | 'SubsInited_MaxWritesExceeded' | 'SubsInited_Exception' | 'SubsInited_exit' | 'SubsInited_end' | 'SubsReady_Enabled' | 'SubsReady_Initializing' | 'SubsReady_Ready' | 'SubsReady_ConfigSet' | 'SubsReady_SubsInited' | 'SubsReady_Any' | 'SubsReady_Reading' | 'SubsReady_ReadingDone' | 'SubsReady_Syncing' | 'SubsReady_SyncDone' | 'SubsReady_Cached' | 'SubsReady_Dirty' | 'SubsReady_QuotaExceeded' | 'SubsReady_Restarting' | 'SubsReady_Restarted' | 'SubsReady_MaxReadsExceeded' | 'SubsReady_Writing' | 'SubsReady_WritingDone' | 'SubsReady_MaxWritesExceeded' | 'SubsReady_Exception' | 'SubsReady_exit' | 'SubsReady_end' | 'Reading_Enabled' | 'Reading_Initializing' | 'Reading_Ready' | 'Reading_ConfigSet' | 'Reading_SubsInited' | 'Reading_SubsReady' | 'Reading_Any' | 'Reading_ReadingDone' | 'Reading_Syncing' | 'Reading_SyncDone' | 'Reading_Cached' | 'Reading_Dirty' | 'Reading_QuotaExceeded' | 'Reading_Restarting' | 'Reading_Restarted' | 'Reading_MaxReadsExceeded' | 'Reading_Writing' | 'Reading_WritingDone' | 'Reading_MaxWritesExceeded' | 'Reading_Exception' | 'Reading_exit' | 'Reading_end' | 'ReadingDone_Enabled' | 'ReadingDone_Initializing' | 'ReadingDone_Ready' | 'ReadingDone_ConfigSet' | 'ReadingDone_SubsInited' | 'ReadingDone_SubsReady' | 'ReadingDone_Reading' | 'ReadingDone_Any' | 'ReadingDone_Syncing' | 'ReadingDone_SyncDone' | 'ReadingDone_Cached' | 'ReadingDone_Dirty' | 'ReadingDone_QuotaExceeded' | 'ReadingDone_Restarting' | 'ReadingDone_Restarted' | 'ReadingDone_MaxReadsExceeded' | 'ReadingDone_Writing' | 'ReadingDone_WritingDone' | 'ReadingDone_MaxWritesExceeded' | 'ReadingDone_Exception' | 'ReadingDone_exit' | 'ReadingDone_end' | 'Syncing_Enabled' | 'Syncing_Initializing' | 'Syncing_Ready' | 'Syncing_ConfigSet' | 'Syncing_SubsInited' | 'Syncing_SubsReady' | 'Syncing_Reading' | 'Syncing_ReadingDone' | 'Syncing_Any' | 'Syncing_SyncDone' | 'Syncing_Cached' | 'Syncing_Dirty' | 'Syncing_QuotaExceeded' | 'Syncing_Restarting' | 'Syncing_Restarted' | 'Syncing_MaxReadsExceeded' | 'Syncing_Writing' | 'Syncing_WritingDone' | 'Syncing_MaxWritesExceeded' | 'Syncing_Exception' | 'Syncing_exit' | 'Syncing_end' | 'SyncDone_Enabled' | 'SyncDone_Initializing' | 'SyncDone_Ready' | 'SyncDone_ConfigSet' | 'SyncDone_SubsInited' | 'SyncDone_SubsReady' | 'SyncDone_Reading' | 'SyncDone_ReadingDone' | 'SyncDone_Syncing' | 'SyncDone_Any' | 'SyncDone_Cached' | 'SyncDone_Dirty' | 'SyncDone_QuotaExceeded' | 'SyncDone_Restarting' | 'SyncDone_Restarted' | 'SyncDone_MaxReadsExceeded' | 'SyncDone_Writing' | 'SyncDone_WritingDone' | 'SyncDone_MaxWritesExceeded' | 'SyncDone_Exception' | 'SyncDone_exit' | 'SyncDone_end' | 'Cached_Enabled' | 'Cached_Initializing' | 'Cached_Ready' | 'Cached_ConfigSet' | 'Cached_SubsInited' | 'Cached_SubsReady' | 'Cached_Reading' | 'Cached_ReadingDone' | 'Cached_Syncing' | 'Cached_SyncDone' | 'Cached_Any' | 'Cached_Dirty' | 'Cached_QuotaExceeded' | 'Cached_Restarting' | 'Cached_Restarted' | 'Cached_MaxReadsExceeded' | 'Cached_Writing' | 'Cached_WritingDone' | 'Cached_MaxWritesExceeded' | 'Cached_Exception' | 'Cached_exit' | 'Cached_end' | 'Dirty_Enabled' | 'Dirty_Initializing' | 'Dirty_Ready' | 'Dirty_ConfigSet' | 'Dirty_SubsInited' | 'Dirty_SubsReady' | 'Dirty_Reading' | 'Dirty_ReadingDone' | 'Dirty_Syncing' | 'Dirty_SyncDone' | 'Dirty_Cached' | 'Dirty_Any' | 'Dirty_QuotaExceeded' | 'Dirty_Restarting' | 'Dirty_Restarted' | 'Dirty_MaxReadsExceeded' | 'Dirty_Writing' | 'Dirty_WritingDone' | 'Dirty_MaxWritesExceeded' | 'Dirty_Exception' | 'Dirty_exit' | 'Dirty_end' | 'QuotaExceeded_Enabled' | 'QuotaExceeded_Initializing' | 'QuotaExceeded_Ready' | 'QuotaExceeded_ConfigSet' | 'QuotaExceeded_SubsInited' | 'QuotaExceeded_SubsReady' | 'QuotaExceeded_Reading' | 'QuotaExceeded_ReadingDone' | 'QuotaExceeded_Syncing' | 'QuotaExceeded_SyncDone' | 'QuotaExceeded_Cached' | 'QuotaExceeded_Dirty' | 'QuotaExceeded_Any' | 'QuotaExceeded_Restarting' | 'QuotaExceeded_Restarted' | 'QuotaExceeded_MaxReadsExceeded' | 'QuotaExceeded_Writing' | 'QuotaExceeded_WritingDone' | 'QuotaExceeded_MaxWritesExceeded' | 'QuotaExceeded_Exception' | 'QuotaExceeded_exit' | 'QuotaExceeded_end' | 'Restarting_Enabled' | 'Restarting_Initializing' | 'Restarting_Ready' | 'Restarting_ConfigSet' | 'Restarting_SubsInited' | 'Restarting_SubsReady' | 'Restarting_Reading' | 'Restarting_ReadingDone' | 'Restarting_Syncing' | 'Restarting_SyncDone' | 'Restarting_Cached' | 'Restarting_Dirty' | 'Restarting_QuotaExceeded' | 'Restarting_Any' | 'Restarting_Restarted' | 'Restarting_MaxReadsExceeded' | 'Restarting_Writing' | 'Restarting_WritingDone' | 'Restarting_MaxWritesExceeded' | 'Restarting_Exception' | 'Restarting_exit' | 'Restarting_end' | 'Restarted_Enabled' | 'Restarted_Initializing' | 'Restarted_Ready' | 'Restarted_ConfigSet' | 'Restarted_SubsInited' | 'Restarted_SubsReady' | 'Restarted_Reading' | 'Restarted_ReadingDone' | 'Restarted_Syncing' | 'Restarted_SyncDone' | 'Restarted_Cached' | 'Restarted_Dirty' | 'Restarted_QuotaExceeded' | 'Restarted_Restarting' | 'Restarted_Any' | 'Restarted_MaxReadsExceeded' | 'Restarted_Writing' | 'Restarted_WritingDone' | 'Restarted_MaxWritesExceeded' | 'Restarted_Exception' | 'Restarted_exit' | 'Restarted_end' | 'MaxReadsExceeded_Enabled' | 'MaxReadsExceeded_Initializing' | 'MaxReadsExceeded_Ready' | 'MaxReadsExceeded_ConfigSet' | 'MaxReadsExceeded_SubsInited' | 'MaxReadsExceeded_SubsReady' | 'MaxReadsExceeded_Reading' | 'MaxReadsExceeded_ReadingDone' | 'MaxReadsExceeded_Syncing' | 'MaxReadsExceeded_SyncDone' | 'MaxReadsExceeded_Cached' | 'MaxReadsExceeded_Dirty' | 'MaxReadsExceeded_QuotaExceeded' | 'MaxReadsExceeded_Restarting' | 'MaxReadsExceeded_Restarted' | 'MaxReadsExceeded_Any' | 'MaxReadsExceeded_Writing' | 'MaxReadsExceeded_WritingDone' | 'MaxReadsExceeded_MaxWritesExceeded' | 'MaxReadsExceeded_Exception' | 'MaxReadsExceeded_exit' | 'MaxReadsExceeded_end' | 'Writing_Enabled' | 'Writing_Initializing' | 'Writing_Ready' | 'Writing_ConfigSet' | 'Writing_SubsInited' | 'Writing_SubsReady' | 'Writing_Reading' | 'Writing_ReadingDone' | 'Writing_Syncing' | 'Writing_SyncDone' | 'Writing_Cached' | 'Writing_Dirty' | 'Writing_QuotaExceeded' | 'Writing_Restarting' | 'Writing_Restarted' | 'Writing_MaxReadsExceeded' | 'Writing_Any' | 'Writing_WritingDone' | 'Writing_MaxWritesExceeded' | 'Writing_Exception' | 'Writing_exit' | 'Writing_end' | 'WritingDone_Enabled' | 'WritingDone_Initializing' | 'WritingDone_Ready' | 'WritingDone_ConfigSet' | 'WritingDone_SubsInited' | 'WritingDone_SubsReady' | 'WritingDone_Reading' | 'WritingDone_ReadingDone' | 'WritingDone_Syncing' | 'WritingDone_SyncDone' | 'WritingDone_Cached' | 'WritingDone_Dirty' | 'WritingDone_QuotaExceeded' | 'WritingDone_Restarting' | 'WritingDone_Restarted' | 'WritingDone_MaxReadsExceeded' | 'WritingDone_Writing' | 'WritingDone_Any' | 'WritingDone_MaxWritesExceeded' | 'WritingDone_Exception' | 'WritingDone_exit' | 'WritingDone_end' | 'MaxWritesExceeded_Enabled' | 'MaxWritesExceeded_Initializing' | 'MaxWritesExceeded_Ready' | 'MaxWritesExceeded_ConfigSet' | 'MaxWritesExceeded_SubsInited' | 'MaxWritesExceeded_SubsReady' | 'MaxWritesExceeded_Reading' | 'MaxWritesExceeded_ReadingDone' | 'MaxWritesExceeded_Syncing' | 'MaxWritesExceeded_SyncDone' | 'MaxWritesExceeded_Cached' | 'MaxWritesExceeded_Dirty' | 'MaxWritesExceeded_QuotaExceeded' | 'MaxWritesExceeded_Restarting' | 'MaxWritesExceeded_Restarted' | 'MaxWritesExceeded_MaxReadsExceeded' | 'MaxWritesExceeded_Writing' | 'MaxWritesExceeded_WritingDone' | 'MaxWritesExceeded_Any' | 'MaxWritesExceeded_Exception' | 'MaxWritesExceeded_exit' | 'MaxWritesExceeded_end' | 'Exception_Enabled' | 'Exception_Initializing' | 'Exception_Ready' | 'Exception_ConfigSet' | 'Exception_SubsInited' | 'Exception_SubsReady' | 'Exception_Reading' | 'Exception_ReadingDone' | 'Exception_Syncing' | 'Exception_SyncDone' | 'Exception_Cached' | 'Exception_Dirty' | 'Exception_QuotaExceeded' | 'Exception_Restarting' | 'Exception_Restarted' | 'Exception_MaxReadsExceeded' | 'Exception_Writing' | 'Exception_WritingDone' | 'Exception_MaxWritesExceeded' | 'Exception_exit' | 'Exception_end';
